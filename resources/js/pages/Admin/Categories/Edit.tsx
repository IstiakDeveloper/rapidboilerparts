...
import { ArrowLeft, Save, X, Tag, Link as LinkIcon, FolderOpen, Hash, ToggleLeft, Eye } from 'lucide-react';
...
export default function Edit({ category, parent_categories = [] }: Props) {
    ...
    const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setData(prev => ({
            ...prev,
            name,
            slug: prev.slug === generateSlug(category.name) ? generateSlug(name) : prev.slug
        }));
    };
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600">Update "{category.name}" category details</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="divide-y divide-gray-200">
                        ...
                        <div className="p-8 space-y-8">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        {parent_categories.filter(cat => cat.id !== category.id).map((cat) => (
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-xs text-gray-500 ml-8">Inactive categories will be hidden from the storefront but remain in admin</p>
                            </div>
                        </div>
