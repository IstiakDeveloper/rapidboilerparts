...
export default function Edit({ serviceProvider, categories, cities, users, productServices, assignedServices }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        // Category
        category_id: serviceProvider.category_id.toString(),
        new_category_name: '',

        // City
        city_id: serviceProvider.city_id.toString(),
        new_city_name: '',
        new_city_region: '',
        new_city_county: '',

        // Area
        area_id: serviceProvider.area_id.toString(),
        new_area_name: '',
        new_area_postcode: '',

        business_name: serviceProvider.business_name || '',
        description: serviceProvider.description || '',
        service_charge: serviceProvider.service_charge,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/service-management/${serviceProvider.id}`);
    };

    return (
        <AdminLayout>
            <Head title={`Edit Service Provider - ${serviceProvider.user.first_name} ${serviceProvider.user.last_name}`} />
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600">Update {serviceProvider.user.first_name} {serviceProvider.user.last_name}'s profile</p>
                    </div>
                    <Link
