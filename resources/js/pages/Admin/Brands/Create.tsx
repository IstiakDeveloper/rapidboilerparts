...
import { ArrowLeft, Save, X, Building2, Link as LinkIcon, Globe, Hash, ToggleLeft, FileText } from 'lucide-react';
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600">Add a new brand or manufacturer to your store</p>
                    </div>
                    <Link
                        href="/admin/brands"
