...
import { ArrowLeft, Save, Settings, Calendar, Tag, Hash } from 'lucide-react';
...
export default function Create({ brands }: PageProps) {
  ...
  return (
    <AdminLayout>
      <Head title="Create Compatible Model" />
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Create Compatible Model</h1>
              <p className="text-gray-600 mt-2">Add a new boiler model for product compatibility</p>
            </div>
          </div>
        </div>
