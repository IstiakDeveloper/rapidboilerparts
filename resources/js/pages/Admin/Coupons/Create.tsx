        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Create a new discount code for customers</p>
            </div>
          </div>
        </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-blue-900 mb-1">Coupon Schedule Tips</div>
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>• Schedule coupons in advance for marketing campaigns</li>
                      <li>• Set expiry dates to create urgency</li>
                      <li>• Use usage limits for exclusive offers</li>
                    </ul>
                  </div>
                </div>
              </div>
