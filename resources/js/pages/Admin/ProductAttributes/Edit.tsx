...
export default function Edit({ attribute }: PageProps) {
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Edit Product Attribute</h1>
              <p className="text-gray-600 mt-2">Update attribute settings and configuration</p>
            </div>
          </div>
        </div>
              ...
              {(data.type === 'select' || data.type === 'multiselect') && (
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    You can manage the available options for this attribute when editing products
                    or through the attribute values section.
                  </p>
                </div>
              )}
            </div>
